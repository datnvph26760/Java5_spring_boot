...
<div class="container" style="margin-top: 30px">
    ...
    <a href="/dong-san-pham/create" class="btn btn-warning">Add</a>
        ...
        <table class="table table-sub-heading-color">
            ...
            <c:forEach items="${list}" var="ds" varStatus="i">
                <tr>
                    ...
                    <td>${ds.ten}</td>
                    <td>
                        <a class="btn btn-primary" href="/dong-san-pham/delete/${ds.id}">Delete</a>
                        <a class="btn btn-danger" href="/dong-san-pham/edit/${ds.id}">Update</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
