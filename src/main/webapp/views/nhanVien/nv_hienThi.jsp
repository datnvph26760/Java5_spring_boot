...
<div class="container" style="margin-top: 30px">
    ...
    <a href="/nhan-vien/create" class="btn btn-warning">Add</a>
        ...
        <table class="table table-sub-heading-color">
            ...
            <c:forEach items="${listNV}" var="nv" varStatus="i">
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="/nhan-vien/delete/${nv.id}">Delete</a>
                        <a class="btn btn-danger" href="/nhan-vien/edit/${nv.id}">Update</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
