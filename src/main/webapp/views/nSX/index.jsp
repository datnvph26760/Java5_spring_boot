...
<div class="container" style="margin-top: 30px">
    ...
    <h3 style="text-align: center">Quản lý nhà sản xuất</h3><br>
    <a href="/nha-san-xuat/create" class="btn btn-warning">Add</a>
        ...
        <table class="table table-sub-heading-color">
            ...
            <c:forEach items="${list}" var="ds" varStatus="i">
                <tr>
                    ...
                    <td>${ds.ten}</td>
                    <td>
                        <a class="btn btn-primary" href="/nha-san-xuat/delete/${ds.id}">Delete</a>
                        <a class="btn btn-danger" href="/nha-san-xuat/${ds.id}">Update</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
