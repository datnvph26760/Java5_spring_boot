...
<div class="container" style="margin-top: 30px">
    ...
    <a href="/cua-hang/create" class="btn btn-warning">Add</a>
    <form action="" method="post">
        <table class="table table-sub-heading-color">
            ...
            <tbody>
            <c:forEach items="${listCH}" var="ch" varStatus="index">
                <tr>
                    <td>${index.index+1}</td>
                    <td>${ch.ma}</td>
                    <td>${ch.ten}</td>
                    ...
                    <td>${ch.quocGia}</td>
                    <td>
                        <a class="btn btn-primary" href="/cua-hang/delete/${ch.id}">Delete</a>
                        <a class="btn btn-danger" href="/cua-hang/edit/${ch.id}">Update</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
