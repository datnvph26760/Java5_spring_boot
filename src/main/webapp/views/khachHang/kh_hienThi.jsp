...
<div class="container" style="margin-top: 30px">
    ...
    <a href="/khach-hang/create" class="btn btn-warning">Add</a>
    <form action="" method="post">
        <table class="table table-sub-heading-color">
            ...
            <tbody>
            <c:forEach items="${listCH}" var="ds" varStatus="i">
                <tr>
                    <td>${i.index+1}</td>
                    <td>${ds.ma}</td>
                    ...
                    <td>${ds.quocGia}</td>
                    <td>
                        <a class="btn btn-primary" href="/khach-hang/delete/${ds.id}">Delete</a>
                        <a class="btn btn-danger" href="/khach-hang/edit/${ds.id}">Update</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
