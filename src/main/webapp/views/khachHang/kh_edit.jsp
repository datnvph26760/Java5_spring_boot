...
<div class="container" style="margin-top: 30px">
    ...
    <f:form action="${action}" method="post" modelAttribute="vm" class="form">
        <h3 style="text-align: center">Update khách hàng</h3>
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <f:errors path="ho" cssClass="error"/>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <f:errors path="tenDem" cssClass="error"/>
        </div>
        <div class="form-group col-md-6">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <f:input path="ngaySinh" inputType="date" id="ngaySinh" class="form-control"/>
            <f:errors path="ngaySinh" cssClass="error"/>
        </div>
        <div class="form-group col-md-6">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <f:errors path="diaChi" cssClass="error"/>
        </div>
        <div class="form-group col-md-6">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <f:input path="thanhPho" id="thanhPho" class="form-control"/>
            <f:errors path="thanhPho" cssClass="error"/>
        </div>
        <div class="form-group col-md-6">
            <label for="quocGia">Quốc Gia</label>
            <f:input path="quocGia" id="quocGia" class="form-control"/>
            <f:errors path="quocGia" cssClass="error"/>
        </div>
    </div>
