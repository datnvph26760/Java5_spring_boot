...
<div class="container" style="margin-top: 30px">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarExample01">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/chi-tiet-san-pham/hien-thi">chi tiet sp</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <h3 style="text-align: center">Quản lý </h3>
    <a href="/chi-tiet-san-pham/create" class="btn btn-warning">Add</a>
        ...
        <table class="table table-sub-heading-color">
            ...
            <c:forEach items="${listCTSP}" var="ctsp" varStatus="i">
                <tr>
                    ...
                    <td>${ctsp.sLTon}</td>
                    <td>
                        <a class="btn btn-primary" href="/chi-tiet-san-pham/delete/${ctsp.id}">Delete</a>
                        <a class="btn btn-danger" href="/chi-tiet-san-pham/edit/${ctsp.id}">Update</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
